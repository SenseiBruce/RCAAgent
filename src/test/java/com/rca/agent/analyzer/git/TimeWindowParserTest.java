...
class TimeWindowParserTest {
  ...
  void parse_lastHours_returnsCorrectRange() {
    ...
    assertThat(Duration.between(range.start(), range.end()))
        .isCloseTo(Duration.ofHours(2), Duration.ofSeconds(1));
  ...
  void parse_lastMinutes_returnsCorrectRange() {
    ...
    assertThat(range).isNotNull();
    assertThat(Duration.between(range.start(), range.end()))
        .isCloseTo(Duration.ofMinutes(30), Duration.ofSeconds(1));
  }
  ...
  void parse_lastDays_returnsCorrectRange() {
    ...
    assertThat(range).isNotNull();
    assertThat(Duration.between(range.start(), range.end()))
        .isCloseTo(Duration.ofDays(7), Duration.ofSeconds(1));
  }
