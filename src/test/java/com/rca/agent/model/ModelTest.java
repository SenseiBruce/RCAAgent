...
class ModelTest {
  ...
  void rcaResponse_recordAccessors() {
    ...
    var gitChange =
        new RcaResponse.GitChange("abc123", "dev", "fix bug", now, List.of("File.java"));
  ...
  void gitChange_recordAccessors() {
    Instant now = Instant.now();
    var change =
        new RcaResponse.GitChange("abc123", "dev", "fix", now, List.of("A.java", "B.java"));
  ...
  void rcaResponse_equality() {
    Instant now = Instant.now();
    RcaResponse r1 =
        new RcaResponse("cause", "HIGH", List.of(), List.of(), List.of(), List.of(), now);
    RcaResponse r2 =
        new RcaResponse("cause", "HIGH", List.of(), List.of(), List.of(), List.of(), now);
