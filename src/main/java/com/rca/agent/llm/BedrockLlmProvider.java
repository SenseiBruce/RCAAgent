 ...
 *
 * <p>Integrates with Amazon Bedrock's InvokeModel API using Claude's Messages format. Activated
 * when {@code rca.llm.provider=bedrock} (default). Requires valid AWS credentials configured via
