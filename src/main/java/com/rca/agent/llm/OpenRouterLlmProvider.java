 ...
 *
 * <p>OpenRouter provides a unified API (OpenAI-compatible) for accessing multiple LLM models
 * (Claude, GPT-4, Gemini, Llama, etc.) through a single endpoint. Activated when {@code
