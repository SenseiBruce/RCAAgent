 ...
 *
 * <p>Implementations of this interface integrate with specific LLM services (e.g., OpenRouter,
 * OpenAI, AWS Bedrock) to perform root cause analysis. The active provider is determined by the
 * {@code rca.llm.provider} configuration property.
 */
