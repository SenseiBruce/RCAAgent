 ...
 *
 * <p>Implementations handle specific log formats (JSON, plaintext, CloudWatch, etc.). The {@link
 * LogAnalyzerService} selects the appropriate parser based on content detection.
 */
