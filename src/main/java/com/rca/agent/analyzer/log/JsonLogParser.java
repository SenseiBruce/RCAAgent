 ...
 *
 * <p>Handles log files where each line is a JSON object with fields like {@code timestamp}, {@code
 * level}, {@code message}, etc. Supports common field name variations (e.g., {@code @timestamp},
 * {@code severity}, {@code msg}).
 */
@Order(10)
@Component
