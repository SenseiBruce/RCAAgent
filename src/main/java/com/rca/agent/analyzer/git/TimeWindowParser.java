 ...
 *
 * <ul>
 *   <li>{@code last Nh} — last N hours (e.g., "last 2h", "last 24h")
 *   <li>{@code last Nm} — last N minutes (e.g., "last 30m")
 *   <li>{@code last Nd} — last N days (e.g., "last 7d")
 *   <li>{@code <ISO> to <ISO>} — explicit range (e.g., "2024-01-15T10:00:00Z to
...
public final class TimeWindowParser {
  ...
  private static final Pattern RELATIVE_PATTERN =
      Pattern.compile("last\\s+(\\d+)\\s*([hHmMdD])", Pattern.CASE_INSENSITIVE);
