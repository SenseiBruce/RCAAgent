 ...
 *
 * <p>Supports both gitlab.com and self-hosted GitLab instances.
 */
@Component
public class GitLabPlatform implements GitPlatform {
  ...
  /**
   * Extracts the base URL (scheme + host) from a GitLab repo URL. Supports both gitlab.com and
   * self-hosted instances.
   *
   * <p>Example: https://gitlab.company.com/team/project.git → https://gitlab.company.com
   */
   ...
   *
   * <p>Example: https://gitlab.com/team/subgroup/project.git → team/subgroup/project
   */
  private String extractProjectPath(String url) {
    return url.replaceAll("https?://[^/]+/", "").replaceAll("\\.git$", "").replaceAll("/$", "");
  }
}
