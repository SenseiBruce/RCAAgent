 ...
 *
 * <p>Binds to the {@code rca.*} prefix in application configuration. All values can be overridden
 * via environment variables or {@code .env} file.
 *
 * <pre>
 * rca:
 *   llm:
...
public class RcaProperties {
  ...
  public static class LlmProperties {
    ...
    public OpenRouterProperties getOpenrouter() {
      return openrouter;
    }

    public void setOpenrouter(OpenRouterProperties openrouter) {
