 ...
 *
 * <ul>
 *   <li>{@code POST /api/v1/rca/analyze} — Submit an issue for root cause analysis
 *   <li>{@code GET /api/v1/rca/health} — Health check endpoint
 * </ul>
 */
@RestController
...
public class RcaController {
  ...
  public ResponseEntity<FixResponse> fix(
      @Valid @RequestBody FixRequest request, @RequestHeader("X-GitHub-Token") String githubToken) {
